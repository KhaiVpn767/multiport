...
wget -O /etc/pam.d/common-password "https://raw.githubusercontent.com/KhaiVpn767/multiport/main/password"
...
wget -O /etc/nginx/nginx.conf "https://raw.githubusercontent.com/KhaiVpn767/multiport/main/nginx.conf"
mkdir -p /home/vps/public_html
wget -O /etc/nginx/conf.d/vps.conf "https://raw.githubusercontent.com/KhaiVpn767/multiport/main/vps.conf"
/etc/init.d/nginx restart

# install badvpn
cd
wget -O /usr/bin/badvpn-udpgw "https://raw.githubusercontent.com/KhaiVpn767/multiport/main/badvpn-udpgw64"
...
apt -y install squid
wget -O /etc/squid/squid.conf "https://raw.githubusercontent.com/KhaiVpn767/multiport/main/squid3.conf"
...
#OpenVPN
wget https://raw.githubusercontent.com/KhaiVpn767/multiport/main/vpn.sh &&  chmod +x vpn.sh && ./vpn.sh

# install lolcat
wget https://raw.githubusercontent.com/KhaiVpn767/multiport/main/lolcat.sh &&  chmod +x lolcat.sh && ./lolcat.sh
...
wget -O /etc/issue.net "https://raw.githubusercontent.com/KhaiVpn767/multiport/main/banner/bannerssh.conf"
echo "Banner /etc/issue.net" >>/etc/ssh/sshd_config
sed -i 's@DROPBEAR_BANNER=""@DROPBEAR_BANNER="/etc/issue.net"@g' /etc/default/dropbear

#Bannerku menu
wget -O /usr/bin/bannerku https://raw.githubusercontent.com/KhaiVpn767/multiport/main/banner/bannerku && chmod +x /usr/bin/bannerku

#install bbr
wget https://raw.githubusercontent.com/KhaiVpn767/multiport/main/system/bbr.sh && chmod +x bbr.sh && ./bbr.sh
