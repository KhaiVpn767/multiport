...
botbckpBot_menu() {
    ...
    echo -e " \e[$number (•1)\e[m \e[$below Setup Bot Telegram\e[m          \e[$number"
    echo -e " \e[$number (•2)\e[m \e[$below Auto Backup Status\e[m          \e[$number"
    echo -e " \e[$number (•3)\e[m \e[$below Backup VPS (Telegram\e[m          \e[$number"
