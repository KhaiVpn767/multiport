...
vmesslink5="vmess://$(base64 -w 0 /usr/local/etc/xray/$user-UMOBILE-FUNZ-PLAN.json)"
vmesslink6="vmess://$(base64 -w 0 /usr/local/etc/xray/$user-YES-HP.json)"
vmesslink7="vmess://$(base64 -w 0 /usr/local/etc/xray/$user-SELCOM-0BASIC.json)"
...
echo -e "\e[$line═════════════════════════════════\e[m"
echo -e "Link UMOBILE-FUNZ-PLAN: ${vmesslink5}"
echo -e "\e[$line═════════════════════════════════\e[m"
echo -e "Link YES-HP           : ${vmesslink6}"
echo -e "\e[$line═════════════════════════════════\e[m"
echo -e "Link SELCOM-0BASIC    : ${vmesslink7}"
echo -e "\e[$line═════════════════════════════════\e[m"
