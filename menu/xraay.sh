...
vlesslink8="vless://${uuid}@104.17.148.22:$none?type=ws&encryption=none&security=none&host=${sts}www.speedtest.net.${domain}&path=$patch#SELCOM_0BASIC-${user}"
vlesslink9="vless://${uuid}@104.17.10.12:$none?type=ws&encryption=none&security=none&host=${sts}cdn.who.int.${domain}&path=$patch#UniFi-${user}"
...
vlesslink6="vless://${uuid}@104.18.8.53:$none?type=ws&encryption=none&security=none&host=${sts}${domain}&path=$patch#VLESS-NTLS-UMOBILE-${user}"
vlesslink7="vless://${uuid}@104.17.113.188:$none?type=ws&encryption=none&security=none&host=${sts}cdn.who.int.${domain}&path=$patch#VLESS-NTLS-YES-${user}"
vlesslink8="vless://${uuid}@104.17.148.22:$none?type=ws&encryption=none&security=none&host=${sts}www.speedtest.net.${domain}&path=$patch#SELCOM_0BASIC-${user}"
vlesslink9="vless://${uuid}@104.17.10.12:$none?type=ws&encryption=none&security=none&host=${sts}cdn.who.int.${domain}&path=$patch#UniFi-${user}"
systemctl restart xray@vless
systemctl restart xray@vnone
