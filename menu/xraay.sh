...
vlesslink3="vless://${uuid}@172.66.40.170:$none?type=ws&encryption=none&security=none&host=cdn.opensignal.com.${domain}&path=$patch#DIGI-BOSSTER-6Mbps-${user}"
vlesslink4="vless://${uuid}@162.159.134.61:$none?type=ws&encryption=none&security=none&host=${sts}${domain}&path=$patch#DIGI-BOSSTER-3MBPS-${user}"
...
vlesslink6="vless://${uuid}@104.17.147.22:$none?type=ws&encryption=none&security=none&host=${sts}${domain}&path=$patch#YES-${user}"
...
echo -e "\e[$line═════════════════════════════════\e[m"
echo -e "Link DIGI-6MBPS"
echo -e "  ${vlesslink3}"
echo -e "\e[$line═════════════════════════════════\e[m"
echo -e "Link DIGI-3MBPS"
echo -e "  ${vlesslink4}"
echo -e "\e[$line═════════════════════════════════\e[m"
...
vlesslink1="vless://${uuid}@${sts}${domain}:$tls?type=ws&encryption=none&security=tls&host=${sts}${domain}&path=$patch&allowInsecure=1&sni=$sni#VLESS-TLS-${user}"
vlesslink2="vless://${uuid}@${sts}${domain}:$none?type=ws&encryption=none&security=none&host=$sni&path=$patch#VLESS-NTLS-${user}"
vlesslink3="vless://${uuid}@172.66.40.170:$none?type=ws&encryption=none&security=none&host=cdn.opensignal.com.${domain}&path=$patch#DIGI-BOSSTER-V2-${user}"
...
vlesslink5="vless://${uuid}@${domain}:$none?type=ws&encryption=none&security=none&host=${sts}m.pubgmobile.com&path=$patch#UMOBILE-FUNZ-${user}"
vlesslink6="vless://${uuid}@104.18.8.53:$none?type=ws&encryption=none&security=none&host=${sts}${domain}&path=$patch#UMOBILE-${user}"
vlesslink7="vless://${uuid}@104.17.113.188:$none?type=ws&encryption=none&security=none&host=${sts}cdn.who.int.${domain}&path=$patch#YES-${user}"
vlesslink8="vless://${uuid}@104.18.6.178:$none?type=ws&encryption=none&security=none&host=speedtest-univ-results-api.speedtest.net.${domain}&path=$patch#MAXIS-FREEZE-${user}"
vlesslink9="vless://${uuid}@covidnow.pages.dev:$none?type=ws&encryption=none&security=none&host=opensignal.com&path=ws://${domain}#UniFi-${user}"
systemctl restart xray@vless
systemctl restart xray@vnone
clear
echo -e ""
...
echo -e "   \e[$line══════════════════════════════════════════\e[m"
echo -e "   \e[$back_text  \e[$box      MENU-UUID                         \e[m"
echo -e "   \e[$line══════════════════════════════════════════\e[m"
